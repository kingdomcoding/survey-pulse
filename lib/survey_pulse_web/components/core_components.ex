defmodule SurveyPulseWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(SurveyPulseWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(SurveyPulseWeb.Gettext, "errors", msg, opts)
    # end
