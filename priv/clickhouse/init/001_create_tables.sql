CREATE TABLE IF NOT EXISTS survey_pulse.responses (
    id              UUID,
    survey_id       UUID,
    wave_id         UUID,
    question_id     UUID,
...
CREATE TABLE IF NOT EXISTS survey_pulse.wave_question_metrics (
    survey_id       UUID,
    wave_id         UUID,
    question_id     UUID,
    age_group       LowCardinality(String),
...
CREATE MATERIALIZED VIEW IF NOT EXISTS survey_pulse.wave_question_metrics_mv
TO survey_pulse.wave_question_metrics
AS
SELECT
    survey_id,
    wave_id,
